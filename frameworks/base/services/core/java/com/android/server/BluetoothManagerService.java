...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    private static final int SERVICE_IBLUETOOTHAAM = 3;
    ...
    private IBluetoothAam mBluetoothAam;
    ...
    public IBluetoothAam getBluetoothAam() {
        // sync protection
        return mBluetoothAam;
    }
    ...
    private class BluetoothServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            } else if (name.equals("com.android.bluetooth.btservice.AamService")) {
                msg.arg1 = SERVICE_IBLUETOOTHAAM;
            } else {
                ...
                case MESSAGE_BLUETOOTH_SERVICE_CONNECTED:
                {
                    ...
                    try {
                        ...
                        if (msg.arg1 == SERVICE_IBLUETOOTHGATT) {
                            ...
                            break;
                        } else if (msg.arg1 == SERVICE_IBLUETOOTHAAM) {
                            mBluetoothAam = IBluetoothAam.Stub.asInterface(service);
                            break;
                        }
            ...
            if (newState == BluetoothAdapter.STATE_OFF) {
                ...
                if (mBluetoothGatt != null) {
                    ...
                    if (mContext.getPackageManager().hasSystemFeature(
                        ...
                        if (DBG) Slog.d(TAG, "Binding Bluetooth AAM service");
                        Intent i2 = new Intent(IBluetoothAam.class.getName());
                        doBind(i2, mConnection, Context.BIND_AUTO_CREATE | Context.BIND_IMPORTANT, UserHandle.CURRENT);
                    }
                }
                sendBleStateChanged(prevState, newState);
