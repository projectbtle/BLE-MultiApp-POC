...
public final class BluetoothDevice implements Parcelable {
    ...
    public BluetoothGatt connectGatt(Context context, boolean autoConnect,
        ...
        BluetoothAdapter adapter = BluetoothAdapter.getDefaultAdapter();
        Log.d("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() Got adapter");
        IBluetoothManager managerService = adapter.getBluetoothManager();
        Log.d("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() Got managerService");
        try {
            IBluetoothGatt iGatt = managerService.getBluetoothGatt();
            Log.d("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() Got iGatt");
            if (iGatt == null) {
            ...
            /* =============== Begin AAM checks =============== */
            IBluetoothAam iAam = managerService.getBluetoothAam();
            if (iAam == null) {
                Log.e("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() iAam is NULL!");
            }
            BluetoothAam aam = new BluetoothAam(iAam);
            ...
            // Get device address.
            String devID = this.getAddress();
            // Get device name.
            String devName = this.getName();
            
            Log.d("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() appID=" + appID + " devID=" + devID + " appName=" + appName + " devName=" + devName);
            
            boolean aamStatus = aam.performAamCheck(appID, devID, appName, devName);
            if (aamStatus == false) {
                // User auth not provided.
                Log.e("CROSSAPPBLE", "/frameworks/base/core/.../BluetoothDevice.java=>connectGatt() User authorisation not provided!" );
                return null;
            }
            /* =============== End AAM checks ================ */
